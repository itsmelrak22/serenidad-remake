        ...
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title accordion-title" id="exampleModalLongTitle">Serenidad Suites Reserve Room</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="admin/queries/addReservation.php" method="POST" class="user" id="CheckDate">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <label for="additional_bed"><p class="accordion-title">Additional Bed</p></label>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <label for="additinal_pax"><p class="accordion-title">Additional Pax</p></label>
